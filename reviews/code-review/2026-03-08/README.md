Version: 0.6.12-review-readme.3
...
2. **Apply-only phase**
   ...
   - In this repo, apply status is recorded in `reviews/code-review/2026-03-08/FULL_CODE_REVIEW_PLAN.md` unless a separate apply artefact is created explicitly
