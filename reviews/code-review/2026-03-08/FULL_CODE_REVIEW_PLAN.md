Version: 0.6.12-review-plan.3
# Pythonista Job Runner Full Code Review Plan

Current location: `reviews/code-review/2026-03-08/FULL_CODE_REVIEW_PLAN.md`
...
- **S01**: runner core
  - review file: `reviews/code-review/2026-03-08/S01_runner_core_review.md`
  - apply status: recorded in this plan file
- **S02**: HTTP API, auth/helpers, audit, support bundle
  - review file: `reviews/code-review/2026-03-08/S02_http_api_review.md`
  - apply status: recorded in this plan file
- **S03**: runner execution pipeline
  - review file: `reviews/code-review/2026-03-08/S03_runner_execution_review.md`
  - apply status: recorded in this plan file
- **S04**: merged storage/lifecycle plus utilities/client/contract
  - review file: `reviews/code-review/2026-03-08/S04_storage_utils_client_review.md`
  - apply status: recorded in this plan file
- **S05**: merged full Web UI source system
  - review file: `reviews/code-review/2026-03-08/S05_webui_full_review.md`
  - apply status: recorded in this plan file
- **S06**: merged full custom integration
  - review file: `reviews/code-review/2026-03-08/S06_custom_integration_full_review.md`
  - apply status: recorded in this plan file
- **S07**: add-on packaging, security, and repository automation
  - review file: `reviews/code-review/2026-03-08/S07_packaging_security_review.md`
  - apply status: recorded in this plan file
...
- **Review output**: `reviews/code-review/2026-03-08/S01_runner_core_review.md`
- **Narrow validations**:
...
- **Review output**: `reviews/code-review/2026-03-08/S02_http_api_review.md`
- **Narrow validations**:
...
- **Review output**: `reviews/code-review/2026-03-08/S03_runner_execution_review.md`
- **Narrow validations**:
...
- **Review output**: `reviews/code-review/2026-03-08/S04_storage_utils_client_review.md`
- **Narrow validations**:
...
- **Review output**: `reviews/code-review/2026-03-08/S05_webui_full_review.md`
- **Narrow validations**:
  - `cd pythonista_job_runner && python app/webui_build.py --check`
...
- **Review output**: `reviews/code-review/2026-03-08/S06_custom_integration_full_review.md`
- **Narrow validations**:
...
- `reviews/code-review/2026-03-08/S06_custom_integration_full_review.md`
- `custom_components/pythonista_job_runner/client.py`
- `custom_components/pythonista_job_runner/__init__.py`
- `custom_components/pythonista_job_runner/services.py`
...
- **Review output**: `reviews/code-review/2026-03-08/S07_packaging_security_review.md`
- **Narrow validations**:
...
- `reviews/code-review/2026-03-08/FULL_CODE_REVIEW_PLAN.md`
- `pythonista_job_runner/config.yaml`
- `pythonista_job_runner/Dockerfile`
