...
"""Scaffold placeholder job for 04_cancel_long_running_job."""
...
def main() -> None:
    ...
    status_text = (
        "Example 04_cancel_long_running_job is a Phase 1 scaffold placeholder. "
