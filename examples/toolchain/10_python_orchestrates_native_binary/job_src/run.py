...
"""Scaffold placeholder job for 10_python_orchestrates_native_binary."""
...
def main() -> None:
    ...
    status_text = (
        "Example 10_python_orchestrates_native_binary is a Phase 1 scaffold placeholder. "
        "The final implementation will be added in a later phase."
    )
    (outputs_dir / "status.txt").write_text(status_text + "\n", encoding="utf-8")
    payload = {
        "example_id": "10_python_orchestrates_native_binary",
        "title": "Python orchestrates native binary",
        "track": "toolchain",
        "status": "scaffold",
